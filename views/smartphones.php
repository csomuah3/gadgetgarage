...
// Configure filters for smartphones (individual category page)
$filter_config = [
    'show_category_filter' => false,  // Hide category filter (already on smartphones page)
    ...
    <div class="container mt-4">
        <div class="row">
            ...
            <div class="col-lg-9 product-grid-container">
                <h2 style="margin-bottom: 20px; color: #1f2937;">Smartphones</h2>
                ...
                <div class="product-count" style="padding: 15px 20px; background: white; border-radius: 8px; margin-bottom: 20px; border: 1px solid #e5e7eb;">
                    ...
                    Showing <strong><?php echo count($products_to_display); ?></strong> of <strong><?php echo $total_products; ?></strong> smartphones
                </div>
