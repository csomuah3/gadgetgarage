...
// Get categories to find desktop category ID
$categories = get_all_categories_ctr();
$desktop_category_id = null;

// Find desktop category by name (case-insensitive)
foreach ($categories as $cat) {
    $cat_name_lower = strtolower(trim($cat['cat_name']));
    if (strpos($cat_name_lower, 'desktop') !== false || 
        strpos($cat_name_lower, 'computer') !== false ||
        $cat_name_lower === 'desktops' ||
        $cat_name_lower === 'desktop') {
...
$filtered_products = $desktop_products;
...
$category_id = $desktop_category_id;
$joint_category_ids = [];
?>
...
<head>
    ...
    <title>Desktops - Gadget Garage</title>
...
<body class="page-background">
    ...
    <div class="container-fluid">
        <div class="text-center py-3">
            <h1 style="color: #1f2937; font-weight: 700; margin: 0;">Desktops</h1>
        </div>
    </div>
