...
<body>
    ...
    <!-- Page Title -->
    <div class="container">
        <h1 class="page-title">Photography & Video</h1>

        <!-- Results Info -->
        <?php if (!empty($filtered_products)): ?>
            <div class="results-info">
                <strong><?php echo $total_products; ?> Photography & Video Product<?php echo $total_products != 1 ? 's' : ''; ?> Found</strong>
            </div>
        <?php endif; ?>

        <!-- Filters Section -->
        <div class="filters-section">
            <h5 class="filter-title">Filter Photography & Video</h5>
            <div class="row">
                <div class="col-md-4">
