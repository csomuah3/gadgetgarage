...
$photo_video_products = array_values(array_unique($photo_video_products, SORT_REGULAR));
...
$category_id = null;
$joint_category_ids = [];
if ($camera_category_id) $joint_category_ids[] = $camera_category_id;
if ($video_category_id) $joint_category_ids[] = $video_category_id;
?>
...
<body class="page-background">
    ...
    <div class="container-fluid">
        <div class="text-center py-3">
            <h1 style="color: #1f2937; font-weight: 700; margin: 0;">Photography & Video</h1>
                        </div>
                    </div>
